...
![](4._神经网络的学习_002.png)yk是表示神经网络的输出，tk表示监督数据，k表示数据的维数。
...
![](4._神经网络的学习_003.png)log表示以e为底数的自然对数（log e），yk是神经网络的输出，tk是正确解标签，tk中只有正确解标签的索引为1，其他均为0
...
导数就是表示某个瞬间的变化量：![](4._神经网络的学习_004.png)
...
如![](4._神经网络的学习_008.png)，由全部变量的偏导数汇总而成的向量称为梯度（gradient）。
...
![](4._神经网络的学习_010.png) η表示更新量，反复执行，逐渐减小函数值
...
![](4._神经网络的学习_013.png)权重W的神经网络，损失函数L

![](4._神经网络的学习_014.png)的元素由各个元素关于W的偏导数构成，形状和W相同

![](4._神经网络的学习_015.png)表示当w11稍微变化时，损失函数L会发生多大变化
