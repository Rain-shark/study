...
![](6._与学习相关的技巧_002.png), '←'表示用右边的值更新左边的值。

需要更新的权重参数记为W，把损失函数关于W的梯度记为![](6._与学习相关的技巧_003.png) ，η表示学习率
...
![](6._与学习相关的技巧_007.png)，变量v，对应物理上的速度
...
h 保存了以前的所有梯度值的平方和（![](6._与学习相关的技巧_010.png)表示对应矩阵元素的乘法）

在更新参数时，通过乘以 ![](6._与学习相关的技巧_011.png)，就可以调整学习的尺度。

参数的元素中变动较大（被大幅更新）的元素的学习率将变小，

即变化较大的元素（h较大，![](6._与学习相关的技巧_012.png)较小）对应学习率变小
...
当激活函数使用ReLU时，一般使用“He初始值”，当前一层的节点数为n时，He初始值使用标准差为 ![](6._与学习相关的技巧_021.png) 的高斯分布。
...
1. L2范数相当于各个元素的平方和。用数学式表示的话，假设有权重W= (w1,w2, ... ,wn)，则L2范数可用![](6._与学习相关的技巧_029.png)计算
