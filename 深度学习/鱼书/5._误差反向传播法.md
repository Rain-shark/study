...
![](5._误差反向传播法_005.png)设存在y = f(x)的计算

反向传播的计算顺序：将信号E乘以节点的局部导数（![](5._误差反向传播法_006.png)），然后将结果传递给下一个节点。
...
z = (x + y)2为：![](5._误差反向传播法_007.png)，则有：![](5._误差反向传播法_008.png)

#### 5.2.3 链式法则和计算图

![](5._误差反向传播法_009.png)t=(x+y)
...
![](5._误差反向传播法_011.png) ![](5._误差反向传播法_012.png)
...
![](5._误差反向传播法_014.png)![](5._误差反向传播法_015.png)
...
![](5._误差反向传播法_019.png)，求导：![](5._误差反向传播法_020.png)
...
简化为：![](5._误差反向传播法_025.png)![](5._误差反向传播法_026.png)

进一步简化：![](5._误差反向传播法_027.png)
...
![](5._误差反向传播法_028.png)矩阵相乘，第一个矩阵列数=第二个矩阵行数
